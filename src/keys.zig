// All the structures and values are based on:
...
// sizeof c_ushort
pub const EVENT_TYPES = enum(u16) {
    EV_SYN = 0x00,
    EV_KEY = 0x01,
    EV_REL = 0x02,
    EV_ABS = 0x03,
...
pub const KEYS = enum(u16){
    ...
    KEY_SCREENLOCK = 152, //KEYS.KEY_COFFEE,
    KEY_ROTATE_DISPLAY = 153,    // Display orientation for e.g. tablets */
    // KEY_DIRECTION = KEYS.KEY_ROTATE_DISPLAY,
    ...
    // KEY_DASHBOARD = KEYS.KEY_ALL_APPLICATIONS,
    KEY_SUSPEND = 205,
...
// Code 255 is reserved for special needs of AT keyboard driver */
    ...
    // BTN_GAMEPAD = 0x130,
    // BTN_SOUTH = 0x130,
    BTN_A = 0x130 , // KEYS.BTN_SOUTH,
    // BTN_EAST = 0x131,
    BTN_B = 0x131, // KEYS.BTN_EAST,
    BTN_C = 0x132,
    // BTN_NORTH = 0x133,
    BTN_X = 0x133, // KEYS.BTN_NORTH,
    // BTN_WEST = 0x134,
    BTN_Y = 0x134, // KEYS.BTN_WEST,
    BTN_Z = 0x135,
    BTN_TL = 0x136,
    BTN_TR = 0x137,
    BTN_TL2 = 0x138,
    ...
    // KEY_ZOOM = KEYS.KEY_FULL_SCREEN,
    KEY_MODE = 0x175,
    KEY_KEYBOARD = 0x176,
    KEY_ASPECT_RATIO = 0x177,    // HUTRR37: Aspect */
    // KEY_SCREEN = KEYS.KEY_ASPECT_RATIO,
    ...
    // KEY_BRIGHTNESS_TOGGLE = KEYS.KEY_DISPLAYTOGGLE,
...
// We avoid low common keys in module aliases so they don't get huge. */
    // KEY_MIN_INTERESTING = KEYS.KEY_MUTE,
    KEY_MAX = 0x2ff,
};
